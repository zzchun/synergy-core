...
ClientProxy1_0::ClientProxy1_0 (const String& name, synergy::IStream* stream,
    ...
    m_events->adoptHandler (m_events->forIStream ().inputReady (),
                            ...
                            new TMethodEventJob<ClientProxy1_0> (
                                this, &ClientProxy1_0::handleData, nullptr));
    m_events->adoptHandler (
        m_events->forIStream ().outputError (),
        stream->getEventTarget (),
        new TMethodEventJob<ClientProxy1_0> (
            this, &ClientProxy1_0::handleWriteError, nullptr));
    m_events->adoptHandler (
        m_events->forIStream ().inputShutdown (),
        stream->getEventTarget (),
        new TMethodEventJob<ClientProxy1_0> (
            this, &ClientProxy1_0::handleDisconnect, nullptr));
    m_events->adoptHandler (
    ...
    m_events->adoptHandler (
        ...
        this,
        new TMethodEventJob<ClientProxy1_0> (
            this, &ClientProxy1_0::handleFlatline, nullptr));
...
void
ClientProxy1_0::setHeartbeatRate (double /*unused*/, double alarm) {
    m_heartbeatAlarm = alarm;
}

void
ClientProxy1_0::handleData (const Event& /*unused*/, void* /*unused*/) {
...
void
ClientProxy1_0::handleDisconnect (const Event& /*unused*/, void* /*unused*/) {
    LOG ((CLOG_NOTE "client \"%s\" has disconnected", getName ().c_str ()));
    disconnect ();
}

void
ClientProxy1_0::handleWriteError (const Event& /*unused*/, void* /*unused*/) {
    LOG ((CLOG_WARN "error writing to client \"%s\"", getName ().c_str ()));
    disconnect ();
}

void
ClientProxy1_0::handleFlatline (const Event& /*unused*/, void* /*unused*/) {
...
void
ClientProxy1_0::setClipboard (ClipboardID /*id*/,
...
void
ClientProxy1_0::keyDown (KeyID key, KeyModifierMask mask,
                         KeyButton /*unused*/) {
...
void
ClientProxy1_0::keyUp (KeyID key, KeyModifierMask mask, KeyButton /*unused*/) {
...
void
ClientProxy1_0::mouseRelativeMove (SInt32 /*xRel*/, SInt32 /*yRel*/) {
    // ignore -- not supported in protocol 1.0
}

void
ClientProxy1_0::mouseWheel (SInt32 /*xDelta*/, SInt32 yDelta) {
...
void
ClientProxy1_0::sendDragInfo (UInt32 /*fileCount*/, const char* /*info*/,
                              size_t /*size*/) {
    // ignore -- not supported in protocol 1.0
...
void
ClientProxy1_0::fileChunkSending (UInt8 /*mark*/, char* /*data*/,
                                  size_t /*dataSize*/) {
    // ignore -- not supported in protocol 1.0
...
ClientProxy1_0::setOptions (const OptionsList& options) {
    ...
    // check options
    for (UInt32 i = 0, n = static_cast<UInt32> (options.size ()); i < n;
         i += 2) {
...
ClientProxy1_0::ClientClipboard::ClientClipboard ()
    : m_sequenceNumber (0), m_dirty (true) {
    // do nothing
}
