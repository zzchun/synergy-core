...
ClientProxyUnknown::ClientProxyUnknown (synergy::IStream* stream,
    ...
    m_events->adoptHandler (
        ...
        new TMethodEventJob<ClientProxyUnknown> (
            this, &ClientProxyUnknown::handleTimeout, nullptr));
...
void
ClientProxyUnknown::handleData (const Event& /*unused*/, void* /*unused*/) {
...
void
ClientProxyUnknown::handleWriteError (const Event& /*unused*/,
                                      void* /*unused*/) {
...
void
ClientProxyUnknown::handleTimeout (const Event& /*unused*/, void* /*unused*/) {
    LOG ((CLOG_NOTE "new client is unresponsive"));
    sendFailure ();
}

void
ClientProxyUnknown::handleDisconnect (const Event& /*unused*/,
                                      void* /*unused*/) {
...
void
ClientProxyUnknown::handleReady (const Event& /*unused*/, void* /*unused*/) {
    sendSuccess ();
}
