...
void
PrimaryClient::keyRepeat (KeyID /*unused*/, KeyModifierMask /*unused*/,
                          SInt32 /*count*/, KeyButton /*unused*/) {
    // ignore
}
...
void
PrimaryClient::sendDragInfo (UInt32 /*fileCount*/, const char* /*info*/,
                             size_t /*size*/) {
    // ignore
}

void
PrimaryClient::fileChunkSending (UInt8 /*mark*/, char* /*data*/,
                                 size_t /*dataSize*/) {
    // ignore
}
