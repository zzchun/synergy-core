...
XArchEvalWinsock::eval () const throw () {
    ...
    static const struct {
        ...
        /* 10035 */
        {WSAEWOULDBLOCK,
         "Socket is marked as non-blocking and no connections are present or "
        ...
        /* 10044 */
        {WSAESOCKTNOSUPPORT,
         "The specified socket type is not supported by this address family"},
        /* 10045 */
        {WSAEOPNOTSUPP,
         "The referenced socket is not a type that supports that operation"},
        ...
        /* 10055 */
        {WSAENOBUFS,
         "No buffer space is available or a buffer deadlock has occured. The "
        ...
        /* 10092 */
        {WSAVERNOTSUPPORTED,
         "The version of WinSock API support requested is not provided in this "
         "implementation"},
        /* 10093 */
